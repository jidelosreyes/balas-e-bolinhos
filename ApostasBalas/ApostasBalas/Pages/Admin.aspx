...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../Scripts/jqwidgets/jqxcheckbox.js" type="text/javascript"></script>
    <script src="../Scripts/jqwidgets/jqxmenu.js" type="text/javascript"></script>
    ...
    <script src="../Scripts/jqwidgets/jqxgrid.pager.js" type="text/javascript"></script>
    <script src="../Scripts/jqwidgets/jqxgrid.sort.js" type="text/javascript"></script>
    <script src="../Scripts/jqwidgets/jqxgrid.edit.js" type="text/javascript"></script>
</asp:Content>
